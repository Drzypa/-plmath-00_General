...
\usepackage{pmmeta}
\pmcanonicalname{TermsFromForeignLanguagesUsedInMathematicshtmlVersion}
\pmcreated{2013-03-22 16:00:07}
\pmmodified{2013-03-22 16:00:07}
\pmowner{Wkbj79}{1863}
\pmmodifier{Wkbj79}{1863}
\pmtitle{terms from foreign languages used in mathematics (html version)}
\pmrecord{53}{38029}
\pmprivacy{1}
...
\pmdefines{a fortiori}
\pmdefines{a priori}
\pmdefines{ad absurdum}
\pmdefines{ad infinitum}
\pmdefines{Ansatz}
\pmdefines{cf.}
\pmdefines{confer}
\pmdefines{doh}
...
\pmdefines{\'etal\'e}
\pmdefines{e.g.}
\pmdefines{exempli gratia}
\pmdefines{ibid.}
\pmdefines{ibidem}
\pmdefines{i.e.}
\pmdefines{id est}
\pmdefines{inter alia}
\pmdefines{logarithmus binaris}
\pmdefines{binary logarithm}
\pmdefines{logarithmus generalis}
\pmdefines{gen}
...
This entry is best viewed in html \PMlinkescapetext{mode}.  For the page \PMlinkescapetext{images} version, \PMlinkname{click here}{TermsFromForeignLanguagesUsedInMathematicsPageImagesVersion}.
